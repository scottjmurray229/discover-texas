...
essentials:
  - icon: "plane"
    label: "Getting There"
    value: "Drive from Corpus Christi (30 min) via ferry or JFK Causeway."
  - icon: "car"
...
<div class="immersive-break-inline">
  <video autoplay muted loop playsinline preload="metadata">
    <source src="/videos/destinations/port-aransas-hero.mp4" type="video/mp4" />
  </video>
...
Port Aransas is one of Texas's most beloved destinations. Known as the "Fishing Capital of Texas," this gulf coast gem delivers authentic Lone Star experiences you won't find anywhere else.
...
Whether you're looking for outdoor adventure, cultural experiences, or great food, Port Aransas has something for everyone.

- **Charter a deep-sea fishing trip** — A must-do for any visitor. This is the experience that puts Port Aransas on the map.
- **Relax on Mustang Island beaches** — Another highlight that showcases the best of the area.
- **Watch dolphins from the jetties** — Round out your visit with this local favorite.

## Where to Eat in Port Aransas

Texas cuisine shines in Port Aransas. From legendary BBQ joints to Tex-Mex favorites and local specialties, you'll eat well here. Budget about $40-$120 per person per day for food.
...
Drive from Corpus Christi (30 min) via ferry or JFK Causeway. Car rental is the most practical way to explore the area.
