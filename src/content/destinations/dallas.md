...
budgetPerDay:
  ...
  midRange: 150
  luxury: 380
gettingThere: "Fly into Dallas/Fort Worth International Airport (DFW) or Dallas Love Field (DAL)."
essentials:
  - icon: "plane"
    label: "Getting There"
    value: "Fly into Dallas/Fort Worth International Airport (DFW) or Dallas Love Field (DAL)."
  - icon: "car"
    label: "Getting Around"
    value: "Car essential or DART light rail for major corridors."
  - icon: "dollar"
    label: "Daily Budget"
    value: "$55-$380 USD per day depending on style."
highlights:
  - "Tour the Arts District"
  - "Visit the Sixth Floor Museum at Dealey Plaza"
  - "Eat smoked brisket at Pecan Lodge"
...
faqItems:
  - question: "What is the Dallas Arts District?"
    answer: "The Dallas Arts District is the largest urban arts district in the United States — 68 contiguous acres with 17 arts organizations. It includes the Winspear Opera House (designed by Norman Foster), the Wyly Theatre (Rem Koolhaas), and the Dallas Museum of Art. The architecture alone is worth a walking tour."
  - question: "Is the Sixth Floor Museum worth visiting?"
    answer: "Yes — the Sixth Floor Museum in the former Texas School Book Depository is one of the most carefully curated assassination sites in the world. It presents the Kennedy assassination with genuine historical care. The window from which Lee Harvey Oswald fired is preserved behind glass exactly as it was. Allow two hours."
  - question: "What is the best BBQ in Dallas?"
    answer: "Pecan Lodge in Deep Ellum is the consensus best — huge beef ribs, outstanding brisket, and homemade sausage. Cattleack Barbeque in North Dallas is often ranked equally high but only opens Thursday–Saturday. Terry Black's has great brisket with no line. All three are better than most BBQ anywhere else in America."
  - question: "What is Deep Ellum?"
    answer: "Deep Ellum is Dallas's historic entertainment and arts neighborhood east of downtown — formerly a blues and jazz hub in the 1920s–40s, now a revitalized district with live music venues, galleries, tattoo shops, restaurants, and murals on virtually every building. The street art alone is worth a walking tour."
  - question: "How does Dallas compare to Fort Worth?"
    answer: "Dallas is glass towers, oil money, arts institutions, and corporate ambition. Fort Worth is boots-on-the-ground Western culture, a working stockyards, and the world's best Western art museum. They're 35 miles apart and genuinely complementary — most visitors do both in one trip."
affiliatePicks:
  - name: "Dallas Hotel Downtown"
    type: hotel
    url: "https://www.booking.com/city/us/dallas.html?aid=2778866"
    description: "Find accommodations in Dallas's Arts District or Uptown neighborhood."
    priceRange: "$$$"
  - name: "Dallas City Tour"
    type: tour
    url: "https://www.getyourguide.com/dallas-l637/?partner_id=IVN6IQ3&q=Dallas+city+tour+Dealey+Plaza"
    description: "Dallas highlights tour including Dealey Plaza and the Arts District."
    priceRange: "$$"
  - name: "Texas BBQ Guide"
    type: activity
    url: "https://www.amazon.com/s?k=texas+bbq+guide&tag=discoverphili-20"
    description: "The definitive guide to Texas BBQ destinations and techniques."
    priceRange: "$"
scottTips:
  logistics: "DFW is 18 miles northwest — 30 minutes to downtown. Love Field (DAL) is 7 miles from downtown and serves Southwest Airlines. DART light rail connects both airports to downtown."
  bestTime: "October–November for ideal weather and the State Fair of Texas (late September–October). March–April for spring blooms at the Arboretum. Avoid June–August heat."
  gettingAround: "Car or DART light rail. The DART Blue, Red, and Orange lines cover the major attractions. Deep Ellum and Uptown are walkable neighborhoods."
  money: "Dallas is expensive. Downtown hotels run $180–$350/night. The food scene is genuinely good but priced to match. BBQ at Pecan Lodge runs $25–$40/person."
  safety: "Dallas is generally safe in tourist areas. Deep Ellum is safe at night with a standard awareness. Research specific neighborhoods."
  packing: "Business casual and upscale are the norms in Dallas dining — it's a city that dresses up. Pack accordingly for nicer restaurants."
  localCulture: "Dallas has a complex identity — it's simultaneously the city that hosted the Kennedy assassination (still raw in local consciousness) and the city of ostentatious wealth, Cowboys football, and genuine world-class arts institutions. It holds the contradictions with practiced ease."
...
<div class="immersive-break-inline" id="arrival">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Land at DFW, merge onto the freeway, and watch the skyline rise out of the flat Texas plains like an argument for ambition.</p>
  </div>
</div>
...
<div class="immersive-break-inline" id="explore">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">World-class art, Dealey Plaza, Deep Ellum music, and the best beef rib in Texas — Dallas overdelivers.</p>
  </div>
</div>
...
<div class="scott-tips">
  <div class="scott-tips-header">&#9992;&#65039; Scott's Dallas Tips</div>
  <ul>
    <li><strong>Getting There:</strong> DFW is 18 miles northwest, 30 minutes to downtown. Love Field (DAL) is 7 miles away and serves Southwest. DART light rail connects both to downtown.</li>
    <li><strong>Best Time:</strong> October–November for the State Fair and ideal weather. March–April for Arboretum spring blooms. Avoid June–August — the concrete absorbs heat differently than smaller Texas cities.</li>
    <li><strong>BBQ:</strong> Pecan Lodge in Deep Ellum is the move. Arrive by 11am — the beef ribs and brisket sell out. Cattleack Barbeque (Thursday–Saturday only) is equally excellent.</li>
    <li><strong>Don't Miss:</strong> The Sixth Floor Museum. It's heavier than you expect and more important to understanding Texas than anything else in the city.</li>
    <li><strong>Avoid:</strong> The Uptown bar scene if you're looking for authentic Dallas culture. Bishop Arts and Deep Ellum are where the real city is.</li>
    <li><strong>Texas Truth:</strong> Dallas is a city of performance and ambition that occasionally reveals genuine substance. The Arts District is not for show — it's a real cultural anchor. The food scene has finally caught up with the money.</li>
  </ul>
</div>
...
<div class="immersive-break-inline" id="food">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Brisket and beef ribs that rival Central Texas, a fine dining scene funded by oil money, and a breakfast taco scene that Austin doesn't want to acknowledge.</p>
  </div>
</div>
...
<div class="immersive-break-inline" id="stay">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">From Arts District boutiques to Uptown towers — Dallas accommodations match the city's ambition.</p>
  </div>
</div>
...
<div class="immersive-break-inline" id="essentials">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Everything you need to know before arriving in Texas's most ambitious city.</p>
  </div>
</div>
