...
budgetPerDay:
  ...
  midRange: 140
  luxury: 320
gettingThere: "Fly into George Bush Intercontinental Airport (IAH) or Hobby Airport (HOU)."
essentials:
  - icon: "plane"
    label: "Getting There"
    value: "Fly into George Bush Intercontinental Airport (IAH) or Hobby Airport (HOU)."
  - icon: "car"
    label: "Getting Around"
    value: "Car essential — Houston is enormous and spread out. METRORail covers limited downtown routes."
  - icon: "dollar"
    label: "Daily Budget"
    value: "$50-$320 USD per day depending on style."
highlights:
  - "Tour Space Center Houston"
  - "Explore the Museum District"
  - "Eat pho in Midtown or the Bellaire Vietnamese corridor"
...
faqItems:
  - question: "Why is Houston so diverse?"
    answer: "Houston became the most ethnically diverse large city in America through oil industry immigration (which brought workers and executives from Latin America, the Middle East, and Southeast Asia), post-Vietnam War refugee resettlement (the Houston Vietnamese community is the third-largest in the US), and geographic position as the Gulf Coast's economic hub. No city in America has a more genuinely international food scene."
  - question: "Is Houston worth visiting for food?"
    answer: "Houston has arguably the best Vietnamese food in America outside of California's Little Saigon communities, outstanding Tex-Mex, an emerging fine dining scene, and immigrant food communities from Nigeria, Vietnam, India, El Salvador, and dozens of other countries. The Bellaire Chinatown and the Mahatma Gandhi District are the two best food corridors."
  - question: "What is Space Center Houston?"
    answer: "Space Center Houston is the official visitor center for NASA's Johnson Space Center — the actual Mission Control for US human spaceflight. The Saturn V rocket on display (363 feet long, lying horizontal) is alone worth the price of admission. The behind-the-scenes tram tour of the actual JSC campus takes you past the historic Mission Control room used during Apollo."
  - question: "What is the Houston Museum District?"
    answer: "The Houston Museum District is a cluster of 19 museums within a 1.5-mile radius in Midtown — including the Museum of Fine Arts Houston (massive encyclopedic collection), Houston Museum of Natural Science, Children's Museum, Holocaust Museum, and more. Several are free or discounted. It's one of the best museum concentrations in the US."
  - question: "How do I get around Houston?"
    answer: "You need a car. Houston is 671 square miles — the largest city by land area in the continental US (Chicago fits inside it). Uber/Lyft work well, but distances between attractions are substantial. The METRORail light rail covers the Museum District to downtown corridor but not much else."
affiliatePicks:
  - name: "Space Center Houston Tickets"
    type: tour
    url: "https://www.getyourguide.com/houston-l521/?partner_id=IVN6IQ3&q=Space+Center+Houston"
    description: "Book Space Center Houston tickets in advance — the behind-the-scenes tram tour sells out."
    priceRange: "$$"
  - name: "Houston Downtown Hotel"
    type: hotel
    url: "https://www.booking.com/city/us/houston.html?aid=2778866"
    description: "Find accommodations in Houston's Museum District or downtown."
    priceRange: "$$"
  - name: "Texas Travel Guide"
    type: activity
    url: "https://www.amazon.com/s?k=houston+texas+travel+guide&tag=discoverphili-20"
    description: "Comprehensive Houston travel guide for planning your visit."
    priceRange: "$"
scottTips:
  logistics: "IAH is 23 miles north — 45 minutes to downtown. Hobby (HOU) is closer at 15 miles southeast. Both are served by all major airlines. Southwest has excellent Houston–Austin and Houston–Dallas routes."
  bestTime: "October–November and March–April. Summers are brutal — 95°F+ with extreme humidity that makes outdoor activities nearly impossible midday. Houston has no significant tourist seasons since it's a business city."
  gettingAround: "Car essential. Distances between neighborhoods are huge. Uber/Lyft are cheap and reliable. Budget extra time for Houston traffic."
  money: "Houston is more affordable than its reputation suggests. Outstanding Vietnamese pho for $10, world-class museum access often free, and hotel rates lower than Austin or Dallas outside of major conferences."
  safety: "Stay in the established tourist areas — Museum District, Midtown, Montrose, River Oaks, Heights. Research your specific neighborhood before walking after dark."
  packing: "Houston summers require light moisture-wicking clothing. The humidity is extreme. Indoor attractions are heavily air-conditioned — bring a layer."
  localCulture: "Houston is genuinely international in a way that most American cities aren't. The Vietnamese, Nigerian, Indian, and Mexican communities here are large enough to sustain authentic cultural life. Eat accordingly."
...
<div class="immersive-break-inline" id="arrival">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Land at IAH, fight through the highways, and arrive in a city so big it has its own weather system.</p>
  </div>
</div>
...
<div class="immersive-break-inline" id="explore">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">NASA, world-class museums, the most diverse food city in America, and a downtown that's finally finding its identity.</p>
  </div>
</div>
...
<div class="scott-tips">
  <div class="scott-tips-header">&#9992;&#65039; Scott's Houston Tips</div>
  <ul>
    <li><strong>Getting There:</strong> IAH is 23 miles north — budget 45 minutes to downtown. Hobby (HOU) is 15 miles southeast and handles Southwest flights. Both airports have Uber/Lyft readily available.</li>
    <li><strong>Best Time:</strong> October–November and March–April for manageable temperatures. February–March for the Livestock Show and Rodeo. Avoid July–August — the humidity is extraordinary.</li>
    <li><strong>Food Strategy:</strong> Start on Bellaire for Vietnamese, then work outward. The Mahatma Gandhi District on Hillcroft has outstanding Indian food. Gulfton has Central American. Midtown has everything.</li>
    <li><strong>Don't Miss:</strong> The Saturn V rocket at Space Center Houston. Stand next to the F-1 engines and reckon with what humans built.</li>
    <li><strong>Avoid:</strong> The "Texas BBQ" tourist traps near downtown. Drive to Gatlin's BBQ or Killen's Barbecue in Pearland for the real thing.</li>
    <li><strong>Texas Truth:</strong> Houston is the most international city in Texas by a wide margin. Embrace the diversity — eat Vietnamese, Nigerian, Indian, and Salvadoran food before you eat Tex-Mex. The Tex-Mex can wait.</li>
  </ul>
</div>
...
<div class="immersive-break-inline" id="food">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Pho that rivals Saigon, Tex-Mex with Mexican-American heritage, and immigrant food communities that make Houston one of America's great eating cities.</p>
  </div>
</div>
...
<div class="immersive-break-inline" id="stay">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Downtown towers, Museum District boutiques, and Montrose guesthouses — Houston has the full range.</p>
  </div>
</div>
...
<div class="immersive-break-inline" id="essentials">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Everything you need to know before landing in America's most underrated major city.</p>
  </div>
</div>
