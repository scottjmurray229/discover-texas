...
budgetPerDay:
  ...
  midRange: 130
  luxury: 300
gettingThere: "Fly into Valley International Airport (HRL) in Harlingen, then drive 30 min to the island."
essentials:
  - icon: "plane"
    label: "Getting There"
    value: "Fly into Valley International Airport (HRL) in Harlingen, 30 minutes from the island via Queen Isabella Causeway."
  - icon: "car"
    label: "Getting Around"
    value: "Car essential. The island is 34 miles long; the developed resort town occupies the southern 5 miles."
  - icon: "dollar"
    label: "Daily Budget"
    value: "$50-$300 USD per day. Spring break prices spike significantly March–April."
highlights:
  - "Swim and sunbathe on the widest beach in Texas"
  - "Watch sea turtle hatchlings at Sea Turtle Inc"
  - "Kayak the Laguna Madre estuary"
...
faqItems:
  - question: "Is South Padre Island really 'tropical'?"
    answer: "By Texas standards, yes. The water temperature at the southern tip of the island reaches 84°F in summer, warmer and clearer than the brownish water of the upper Texas coast. The Gulf here is genuinely turquoise-blue in good conditions. The palm trees are real and not planted for aesthetics. The climate is subtropical. It's not the Caribbean, but it's as close as Texas gets."
  - question: "What is spring break at South Padre like?"
    answer: "South Padre Island's spring break (late February through mid-April) is one of the largest spring break events in the US, drawing 250,000+ college students over several weeks. The beach becomes an extended party zone. Hotels triple or quadruple in price. If you're coming for the spring break experience, go in. If you want a relaxed beach vacation, avoid those dates entirely."
  - question: "What is Sea Turtle Inc?"
    answer: "Sea Turtle Inc is a sea turtle rescue and rehabilitation center in South Padre Island that releases recovered sea turtles and has a public education center. The facility rescues cold-stunned sea turtles by the hundreds each November–December when cold fronts suddenly lower the bay temperature. Daily public feedings at 10am (free) are popular. During mass cold-stun rescues, they accept volunteers."
  - question: "What is birding like at South Padre Island?"
    answer: "South Padre Island is one of the premier birding destinations in North America during the spring migration (April–May). The island sits on the Gulf Coast flyway, and exhausted migratory birds land here in huge numbers after crossing the Gulf from the Yucatan. On good 'fall-out' days when birds arrive by the thousands, the World Birding Center on the island can be extraordinary."
affiliatePicks:
  - name: "South Padre Island Hotel"
    type: hotel
    url: "https://www.booking.com/city/us/south-padre-island.html?aid=2778866"
    description: "Find beachfront hotels and condos on South Padre Island."
    priceRange: "$$$"
  - name: "South Padre Dolphin Watch Tour"
    type: tour
    url: "https://www.getyourguide.com/?partner_id=IVN6IQ3&q=South+Padre+Island+dolphin+tour"
    description: "Dolphin watching and Laguna Madre boat tours from South Padre Island."
    priceRange: "$$"
  - name: "Texas Coast Travel Guide"
    type: activity
    url: "https://www.amazon.com/s?k=south+padre+island+travel+guide&tag=discoverphili-20"
    description: "Complete Texas Gulf Coast travel guide including South Padre Island."
    priceRange: "$"
scottTips:
  logistics: "Harlingen airport (HRL) is 30 minutes from the island. McAllen airport (MFE) is 60 minutes. The Queen Isabella Causeway is the only road onto the island. Spring break season (March–April) requires booking 3–6 months ahead at significantly higher prices."
  bestTime: "October–November for great weather, empty beaches, and sea turtle cold-stun rescue season. April–May for birding migration. Avoid spring break unless that's specifically why you're coming."
  gettingAround: "Car essential. The developed resort strip is 5 miles long at the southern tip. The undeveloped northern 29 miles require 4WD."
  money: "Outside spring break, South Padre is surprisingly affordable. Hotel rates drop to $80–$150/night in fall. Spring break rates can hit $400–$600/night for the same rooms."
  safety: "Rip currents are strong on the Gulf side — swim near lifeguard stations. Hurricane season is real — late summer and early fall, watch the Gulf carefully."
  packing: "Sunscreen (the subtropical UV is intense), water shoes for the beach rocks, snorkeling gear, and insect repellent for evening Laguna Madre activities."
  localCulture: "South Padre has a split personality — spring break party city March–April, then a genuinely peaceful Gulf Coast resort town the rest of the year. The bird and turtle conservation communities are serious and welcoming."
...
<div class="immersive-break-inline" id="arrival">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Cross the Queen Isabella Causeway, watch the Gulf open ahead of you, and arrive at the southernmost beach in Texas where the water actually looks tropical.</p>
  </div>
</div>
...
<div class="immersive-break-inline" id="explore">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Sea turtle rescue, world-class bird migration, Laguna Madre kayaking, and the warmest Texas Gulf water — South Padre rewards the curious visitor.</p>
  </div>
</div>
...
<div class="scott-tips">
  <div class="scott-tips-header">&#9992;&#65039; Scott's South Padre Island Tips</div>
  <ul>
    <li><strong>Getting There:</strong> Harlingen (HRL) is 30 minutes via the causeway. McAllen (MFE) is 60 minutes. The Queen Isabella Causeway is the only way on and off the island — watch for storm closure notices.</li>
    <li><strong>Best Time:</strong> October–November for perfect weather, empty beaches, and sea turtle cold-stun season. April–May for spring migration birding. Avoid spring break unless you specifically want it.</li>
    <li><strong>Spring Break:</strong> If you're coming during spring break, book 3–6 months ahead and expect 3–4x normal prices. If you're not coming for spring break, avoid the island from mid-March to mid-April entirely.</li>
    <li><strong>Don't Miss:</strong> Sea Turtle Inc's 10am feeding is free, excellent, and completely different from anything else on the island. The World Birding Center on a spring migration day is extraordinary.</li>
    <li><strong>Avoid:</strong> Treating the Laguna Madre side as just the back of the island. The bay kayaking is genuinely better wildlife-watching than the Gulf side beach.</li>
    <li><strong>Texas Truth:</strong> The warmest, clearest Gulf water in Texas is at South Padre. The subtropical latitude makes a real difference. The water here is genuinely blue, not the murky brown of Galveston.</li>
  </ul>
</div>
...
<div class="immersive-break-inline" id="food">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Gulf shrimp practically straight off the boat, Rio Grande Valley Mexican food with deep South Texas roots, and beach tacos that are better than they need to be.</p>
  </div>
</div>
...
<div class="immersive-break-inline" id="stay">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Beachfront condos, Gulf-view hotels, and budget options in Port Isabel across the causeway — all pricing doubles during spring break.</p>
  </div>
</div>
...
<div class="immersive-break-inline" id="essentials">
  ...
  <div class="ib-content">
    ...
    <p class="ib-text">Everything you need to know before visiting the southernmost and warmest beach in Texas.</p>
  </div>
</div>
